...
export type CollectionByHandle_MainCollectionQueryVariables =
  StorefrontAPI.Exact<{
...
export type CollectionByHandle_MainCollectionQuery = {
...
export type CollectionByHandle_MaterialsQuery = {
  collection?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Collection, 'id' | 'title' | 'handle'> & {
      image?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Image, 'id' | 'url' | 'altText' | 'width' | 'height'>
      ...
      products: {
        nodes: Array<
          Pick<StorefrontAPI.Product, 'id' | 'title' | 'handle'> & {
            ...
            >;
            neoColorProduct?: StorefrontAPI.Maybe<
              Pick<StorefrontAPI.Metafield, 'type'> & {
                references?: StorefrontAPI.Maybe<{
                  nodes: Array<
            ...
            variants: {
              nodes: Array<
                Pick<StorefrontAPI.ProductVariant, 'id'> & {
                  neoColorVariants?: StorefrontAPI.Maybe<
                    Pick<StorefrontAPI.Metafield, 'type'> & {
                      references?: StorefrontAPI.Maybe<{
                        nodes: Array<
                          Pick<StorefrontAPI.Metaobject, 'id'> & {
...
export type DealersQueryVariables = StorefrontAPI.Exact<{
  first: StorefrontAPI.Scalars['Int']['input'];
}>;
...
export type DiaByHandlesQueryVariables = StorefrontAPI.Exact<{
  mirror: StorefrontAPI.Scalars['String']['input'];
  brass: StorefrontAPI.Scalars['String']['input'];
}>;

export type DiaByHandlesQuery = {
  mirror?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Product, 'id' | 'handle' | 'title'> & {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query Dealers($first: Int!) {\n    metaobjects(type: "dealers", first: $first) {\n      nodes {\n        id\n        fields { key value }\n      }\n    }\n  }\n': {
    return: DealersQuery;
    variables: DealersQueryVariables;
  };
  '#graphql\n  query Page(\n    $language: LanguageCode,\n    $country: CountryCode,\n    $handle: String!\n  )\n  @inContext(language: $language, country: $country) {\n    page(handle: $handle) {\n      handle\n      id\n      title\n      body\n      seo {\n        description\n        title\n      }\n    }\n  }\n': {
    return: PageQuery;
